...
public class vista{
    ...
    public void kaqchikel_a_espanol(String e)
    {
        traductor t = new traductor();
        if(t.checkkaq(e))
        {
            JOptionPane.showMessageDialog(null,"Traducción: " + t.kae(e) + "\n");
        }        
        else
        {
            Pno_existe();
    ...
    //función relevada por kaqchikel_a_espanol
    ...
    public void Pnumero_invalido(){
        JOptionPane.showMessageDialog(null,"Por favor ingrese un numero valido","ALERTA!!",JOptionPane.WARNING_MESSAGE);//ALERTA
    }
    ...
    public void Pnuestra_historia(){
        ...
        JOptionPane.showMessageDialog(null,"\n\t\t\tNUESTRA HISTORIA \n Somos un grupo de estudiantes de la Universidad del Valle de Guatemala con el objetivo de ayudar a nuestro país en sus dificultades. \n Durante nuestro curso de Programación Orientada a Objetos, tuvimos la oportunidad de ponernos manos a la obra y comenzar un proyecto. \n Decidimos que tenía que ser algo dirigido a la calidad educativa e igualdad entre los guatemaletecos; de esta manera, surgió la idea de K'. \n Esta es una aplicacion que permite a las personas de nuestra bella nación reconectar con sus raices a través de los lenguajes nativos. \n Consideramos que si nosotros, como ciudadanos, buscamos herramientas para comunicarnos unos con otros, la brecha de la desigualdad se reducirá. \n \nGracias por apollarnos","NUESTRA HISTORIA", JOptionPane.PLAIN_MESSAGE);
    ...
    public String creapregunta(String pregunta){
        String respuesta = JOptionPane.showInputDialog(null, pregunta, "Ingrese la palabra...");//JOptionPane.showInputDialog(null, pregunta);
        return respuesta;
    }
